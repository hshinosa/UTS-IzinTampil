          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-700 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-gray-800 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div className="text-center">
                ...
                <p className="text-xs font-mono text-gray-700 dark:text-gray-300">admin@example.com</p>
                <p className="text-xs font-mono text-gray-500 dark:text-gray-400">admin123</p>
              </div>
              <div className="text-center">
                <p className="text-xs text-gray-500 dark:text-gray-400">User</p>
                <p className="text-xs font-mono text-gray-700 dark:text-gray-300">user@example.com</p>
                <p className="text-xs font-mono text-gray-500 dark:text-gray-400">user123</p>
              </div>
            </div>
          </div>
        </form>
