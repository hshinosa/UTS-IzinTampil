...
const mockAnalyticsData = {
  ...
  tasksByDate: [
    { date: '1 Jan', completed: 15, created: 18 },
    { date: '2 Jan', completed: 12, created: 15 },
    { date: '3 Jan', completed: 20, created: 14 },
    { date: '4 Jan', completed: 18, created: 22 },
    { date: '5 Jan', completed: 13, created: 16 }
  ],
